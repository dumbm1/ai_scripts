...
//    сокращения для элементов окна
    ...
    var face = new Window ( 'palette', 'Вставить символ' );
...
//    event hendlers
    ...
    face.btPan.ok.onClick = function () {
      ...
      bt.body = "\
      if(selection == ''){\
        newTxtFrame = app.activeDocument.textFrames.add ();\
        newTxtFrame.contents = '" + resultStr + "';\n" +
        "newTxtFrame.selected = true" +
      "}"
      bt.send ();
      selection.textRange.characterAttributes.textFont = 'ArialUnicodeMS'
