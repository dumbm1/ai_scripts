...
//dont triggeted on enter keydown becaouse in palette-window the Ok button isn't active
  ...
  function repl (regStr, replacer) {
    ...
    var a, b, i, fullCont, fullContMod;
    executeMenuCommand ('deselectall');
    
    selFrame.textRange.characters[0].select ();

    for (i = 0; i < selection[0].textRange.characters.length - 1; i++) {
