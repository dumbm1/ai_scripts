/**
 * ai.jsx ©MaratShagiev m_js@bk.ru 29.03.2015
 */
//@target illustrator-19
var opts1 = {
  fileName:     '098054426_VP_paket_hleb_pribaltiyskiy_narezka',
  colsCmyk:     [ 'cmyk' ],
  colsPant:     [ '286', '875', 'Black' ],
  colsServ:     [ 'w', /*'w2', 'l','pr'*/ ],
  lays:         [ 'color', 'test' ],
  z:            [ 430 ],
  margins:      10,
  ...
  docW:         function () {
    return this.filmW + this.margins * 2;
  },
  docH:         function () {
    return this.z[ 0 ] - 6 + this.margins * 2;
  }
};
...
function makeupDots ( o ) {
  ...
  function _makeTitle ( o ) {
    ...
    titleGroup.position = [ activeDocument.width / 2 - titleGroup.width / 2,
                            activeDocument.height - o.margins / 2 - titleGroup.height / 2
    ];
    ...
    (function makeTitleMini () {
      ...
      crossGroup.translate (
        o.margins * PT_TO_MM + o.dotIndent * PT_TO_MM + crossGroup.width,
